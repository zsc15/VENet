...
parser.add_argument('--exp', type=str,  default='VENet_adam_arctan_six_scales', help='model_name')
parser.add_argument('--scale', type=list,  default=[2, 1, 4/3, 0.716, 0.693, 2/3], help='scales of image')
